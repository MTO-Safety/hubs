...
const CLOCK_SCALE = 0.15;
const CLOCK_POSITION = { x: -3.85, y: 2.35, z: 5.4 };
...
AFRAME.registerSystem("digital-clock", {
  init: function() {
    ...
    const clockMaterial = new THREE.MeshBasicMaterial({ color: BACKGROUND_COLOR });
    ...
    const digitMat = new THREE.LineBasicMaterial({ color: DIGIT_COLOR });
